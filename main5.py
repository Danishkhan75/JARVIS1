...
# ╔══════════════════════════════════════════════════════════════════════════════╗
# ║                                                                              ║
# ║            JARVIS AI v12.1 - FULL SYSTEM ACCESS EDITION                     ║
# ║                                                                              ║
# ║  ✅ Complete System Control (Volume, Apps, Task Manager)                   ║
# ║  ✅ YouTube Playback (3 Strategies)                                         ║
# ║  ✅ Media Control (Play, Pause, Next, Volume)                             ║
# ║  ✅50+ Apps (Facebook, Spotify, YouTube, etc.)                            ║
# ║  ✅ Frontend Compatible (Beautiful HTML UI)                                ║
...
#             logger.info(f"✓ Shutdown initiated (delay: {delay}s)")
#             return True
#         except Exception as e:
...
#             logger.info(f"✓ Restart initiated (delay: {delay}s)")
#             return True
#         except Exception as e:
...
#                     success = True
#                     message = "ℹ️ System info displayed"
#                 else:
#                     success = False
...
#     print("╔" + "═" * 78 + "╗")
#     print("║" + " " * 78 + "║")
#     print("║" + "🚀 JARVIS AI v12.1 - FULL SYSTEM ACCESS - STARTING...".center(78) + "║")
#     print("║" + " " * 78 + "║")
#     print("╚" + "═" * 78 + "╝")
#     print()
    
#     print("✓ Features Enabled:")
#     print("  • Complete System Control (Volume, Apps, Task Manager)")
#     print("  • YouTube Playback (3 strategies)")
#     print("  • Media Control (play, pause, next, volume)")
#     print("  • 50+ Apps Support (Facebook, Spotify, YouTube, etc.)")
#     print("  • Frontend Compatible (Beautiful HTML UI)")
#     print("  • Groq LLaMA 3.3" if CONFIG["groq_key"] else "  • Groq - Disabled")
#     print()
    
#     print("📡 Server starting on http://127.0.0.1:8000")
#     print("🌐 Frontend: Open the HTML file in your browser")
...
╔══════════════════════════════════════════════════════════════════════════════╗
║                                                                              ║
║     JARVIS AI v12.0 - INTEGRATED WITH REAL-TIME SEARCH ENGINE               ║
║                                                                              ║
║  ✅ Real-Time Web Search (Google Custom Search)                             ║
║  ✅ YouTube Playback (ACTUALLY WORKS)                                       ║
║  ✅ Media Control (play, pause, next, volume)                               ║
